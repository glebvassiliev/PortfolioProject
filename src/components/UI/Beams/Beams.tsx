...
const CanvasWrapper: FC<{ children: ReactNode; frameloop?: 'always' | 'demand' }> = ({
  children,
  frameloop = 'always'
}) => (
  <Canvas dpr={[1, 2]} frameloop={frameloop} className="w-full h-full relative">
    {children}
  </Canvas>
);
...
const Beams: FC<BeamsProps> = ({
  ...
  // Hybrid perf: pause animation during active scroll (keeps visual quality; improves scroll smoothness).
  useEffect(() => {
  ...
  return (
    <CanvasWrapper frameloop={isScrolling ? 'demand' : 'always'}>
